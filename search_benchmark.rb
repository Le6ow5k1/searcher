...
@criteria = Hash[:age => 99..100, :salary => 1000.0..80000.0, :height => 200, :weight => (1..200)]
...
Benchmark.bmbm do |rep|
  ...
  rep.report("add_indexes: ") { @searcher.add_indexes(@testData, [:salary]) }
  rep.report("select: ") { @searcher.select_from_index(:salary, 10000..1000000.0) }
